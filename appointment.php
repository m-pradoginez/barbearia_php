	...
	<div class="container">
		...
		<?php
            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
					// Verifica se o e-mail do cliente já consta na base de dados
                    ...
                    echo "<div class = 'alert alert-success'>";
                        echo "Boa notícia! Seu horário foi agendado com sucesso, obeigado.";
                    echo "</div>";
		...
		<form method="post" id="appointment_form" action="appointment.php">
			...
			<div class="select_employee_div tab_reservation" id="employees_tab">
				...
				<div class="alert alert-danger" role="alert" style="display: none">
					Por favor, selecione o profissional!
				</div>

				<div class="text_header">
					<span>
						2. Escolha do funcionário
					</span>
				</div>
                ...
                <div>
                    <div class="form-group colum-row row">
                        ...
                        <div class="col-sm-6">
							...
							<span class = "invalid-feedback">E-mail inválido</span>
                        </div>
                        <div class="col-sm-6">
			...
			<div style="overflow:auto;padding: 30px 0px;">
    			<div style="float:right;">
    				<input type="hidden" name="submit_book_appointment_form">
      				<button type="button" id="prevBtn"  class="next_prev_buttons" style="background-color: #bbbbbb;"  onclick="nextPrev(-1)">Voltar</button>
      				<button type="button" id="nextBtn" class="next_prev_buttons" onclick="nextPrev(1)">Próximo</button>
    			</div>
  			</div>

  			<!-- Indicativo da etapa do formulário: -->
