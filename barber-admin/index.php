                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Listagem dos agendamentos por vir serão mostradas aqui";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Cancelar Agenda</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p>Quer mesmo cancelar esse horário?</p>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" data-id = "<?php echo $row['appointment_id']; ?>" class="btn btn-danger cancel_appointment_button">Sim</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($count == 0)
                                {
                                    ...
                                    echo "<tr>";
                                        echo "<td colspan='5' style='text-align:center;'>";
                                            echo "Lista de todos seus agendamentos aparecerá aqui";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                else
