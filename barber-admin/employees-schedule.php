<?php
    ...
    {
?>
        <!-- Começo da conteúdo da página -->
        <div class="container-fluid">
    
            <!-- Cabeçalho da página -->
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Agendamento de funcionários</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Agendamento de funcionários</h6>
                </div>
                <div class="card-body">
                        ...
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                <label class="control-label" for="emloyee_schedule_select">
                                    Selecione o funcionário para marcar um horário:
                                </label>
                                ...
                                <button type="submit" name="show_schedule_sbmt" class="btn btn-primary">Mostrar horários</button>
                            </div>
                        </form>
                    </div>
                    
                    <div class="alert alert-info">
                        Editar suas configurações semanais. Selecione a data de início e fim para definir o horário de trabalho de um funcionário.
                    </div>
                    ...
                    <div class="sb-content" style="min-height: 500px;">
                        ...
                        ?>
                                <form method="POST" action="employees-schedule.php">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="save_schedule_sbmt" class="btn btn-info">Salvar horário</button>
                                    </div>
                                </form>
                        <?php
                            }
                        ...
                        if(isset($_POST['save_schedule_sbmt']))
                        {
                            ...
                            foreach($days as $key=>$value)
                            {
                                ...
                                {   
                                    ...
                                    $message = "Você atualizou com sucesso o agendamento com o funcionário!";
